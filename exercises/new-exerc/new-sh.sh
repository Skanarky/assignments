...
echo "24. 'DollarSign#' contains the total amount of passed params in a fn or script file"
echo "24. 'DollarSign*' contains all the passed params in a fn or script file"
