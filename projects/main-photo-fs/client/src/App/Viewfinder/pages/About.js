    ...
    return (
        <section className="aboutWrap">
            ...
            <ul>
                ...
                <li><h4>No expensive cameras or image-processing softwares required!</h4></li>
            </ul>
            <div>
                ...
                <p>In this web app you’ll learn how to use your emotions as a creative power, train your eyes, plan your shoots, and not in a last place - how to use the art compositions to bring the most of your pictures.</p>
                <p>We will focus more on making pictures and less on camera devices.</p>
                ...
                <p>Have fun - and start <span className="red">making</span> great pictures <span className="red">today</span>… your eyes is all you need!</p>
            </div>
        </section>
    )
}
