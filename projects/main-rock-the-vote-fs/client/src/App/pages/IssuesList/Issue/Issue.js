...
class Issue extends React.Component {
    ...
    render = () => {
        ...
        const presentIssues = data.sort((issueOne, issueTwo) => issueOne.upVotes < issueTwo.upVotes).map((issue, i) => <IssueDisplay key={issue._id + i} id={issue._id} index={i} {...issue}></IssueDisplay>);
        if (loading) {
            return (
